...
import com.SevenDigITs.Solutions.justTap.user.medication.mpill.ViewController.adapter.TabsAdapter;
...
public class MainActivityBill extends AppCompatActivity implements android.support.v7.app.ActionBar.TabListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_bill_action);
        ...
        getSupportActionBar().setTitle("Bill Reminder");
    ...
    public void onBackPressed() {
        Intent returnHome = new Intent(MainActivityBill.this, HealthyUserActivity.class);
