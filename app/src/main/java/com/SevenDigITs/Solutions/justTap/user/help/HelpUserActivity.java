package com.SevenDigITs.Solutions.justTap.user.help;
...
/** this if for check about button fullscreen */
        ...
        if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            /** Getting video uri */
            String vidAddress = "https://firebasestorage.googleapis.com/v0/b/just-tap-3d747.appspot.com/o/videos%2FJustTap%20User.mp4?alt=media&token=2d5dc91b-c840-4995-b694-613d2aa653fa";
            ...
            videoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mp) {
                    intentLessone2 = new Intent(getApplicationContext(), MainUserActivity.class);
