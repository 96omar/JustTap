package com.SevenDigITs.Solutions.justTap.user.medication.mpill.ViewController;
...
import com.SevenDigITs.Solutions.justTap.user.medication.mpill.Model.Alarm;
import com.SevenDigITs.Solutions.justTap.user.medication.mpill.Model.Pill;
import com.SevenDigITs.Solutions.justTap.user.medication.mpill.Model.PillBox;
import com.SevenDigITs.Solutions.justTap.user.medication.mpill.Model.PillComparator;
import com.SevenDigITs.Solutions.justTap.user.medication.mpill.ViewController.adapter.ExpandableListAdapter;
...
public class PillBoxActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent returnHome = new Intent(getBaseContext(), MainActivityBill.class);
